...
<head>
    ...
    <style>
        ...
        /* Make the View Products link black */
        table td a {
...
<body>
    ...
    <main>
        ...
        <table>
            ...
            <tbody>
                <%
                    // Get the sellers list from the request attribute
                ...
                %>
                    <tr>
                        ...
                        <td>
                            <form action="/seller/delete" method="post" style="display:inline;">
                                <input type="hidden" name="sellerId" value="<%= seller.getId() %>">
                                <input type="submit" value="Delete">
                            </form>
                        </td>
                        <td>
                            <a href="/seller/products?sellerId=<%= seller.getId() %>">View Products</a>
                        </td>
                    </tr>
                <%
                        }
